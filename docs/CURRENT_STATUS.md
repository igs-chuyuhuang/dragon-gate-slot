...
> 最後更新：2026-06-04 16:13 by 特效爽感-gf-t326
...
### 程式前端/UI
- ✅ 3×3 盤面 + 垂直滾動 strip 動畫（overshoot bounce）
- ✅ 停軸順序左→右→中 + 穿門/碰壁列高亮
- ✅ 規則說明頁面（右上角 ? 按鈕）
...
- [x] P1: 碰壁特效太弱 — 已加大 shake 14px/300ms + 裂痕 overlay 持續 1.2s
- [x] P1: Scatter 缺少獨立揭曉動畫 — 已加光柱+持續震動+逐一揭曉強化
- [x] P2: 穿門 flash 太強遮蓋盤面 — 透明度從 0.4 降到 0.28
- [x] P2: 高 Combo 光暈太濃導致盤面不可見 — flash/glow 減量 30%
- [ ] P0: Big Win「DRAGON」文字截斷修復
- [ ] P3: JP 進度條視覺精緻度提升
...
## 最近完成
- [6/4] P1+P2 特效修正：碰壁強化(shake 14px+裂痕 overlay)、Scatter 光柱+震動、穿門降透明、Combo 降光暈
- [5/30] 瞇牌緊張感特效體感設計方案
