...
> 最後更新：2026-05-27 17:41 by 企劃-qa-t82
...
### 美術音效
- ✅ 13 張牌面素材統一國潮風格（模板+PIL疊字方式，文字風格完全一致）
- ✅ 牌面模板系統：template_mid（2~10）+ template_high（A/J/Q/K）
- ✅ 合成腳本：art/scripts/generate_symbols.py（可重複執行）
- ✅ Scatter 龍圖片
- ✅ 7 張特效圖片素材
- ✅ 背景圖（中式宮殿門樓）
...
## 最近完成
- [5/27] 用 assetsv2 新素材重做遊戲畫面（手機版 9:16：龍門外框、翡翠牌面、紅金操作列、小龍吉祥物）
- [5/27] 修復 Free Game 自動轉停頓問題
- [5/26] 牌面 symbol 統一化：改為模板+PIL疊字，13張牌面文字風格完全一致
