...
| 程式-核心邏輯 | Web Core Developer Agent | 穿門判定、Free Game、JP |
| 程式-前端/UI | Web Frontend Agent | UI、動畫、特效整合（Anime.js + PixiJS）|
...
- Free Game 大龍門挑戰
- 技術棧：HTML5 + JavaScript ESM + Anime.js + PixiJS + Lottie-web
